...
axis(1, 10 ^ (2:5), label = c(expression(10^2),
                          ...
                          expression(10^4),
                          expression(10^5)),
     col.axis = "grey50", cex.axis = 0.8, tick = FALSE)
axis(2, 10^c(-3, -1, 1, 3), label = c(expression(10^-3), #expression(10^-2),
                           ...
                           expression(10^3)),
     col.axis = "grey50", cex.axis = 0.8, tick = FALSE)
b1 = c(0.001, 0.003, 0.005, 0.011, 0.025, 0.054, 0.113,
       0.247, 0.533, 1.146)
